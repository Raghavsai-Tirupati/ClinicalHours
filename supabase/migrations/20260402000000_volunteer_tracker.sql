...
-- Tables: volunteer_tracker_categories, volunteer_tracker_columns,
--         volunteer_tracker_entries, volunteer_tracker_values

-- ============================================================
-- 1. volunteer_tracker_categories — role groupings per clinic
-- ============================================================
...
CREATE INDEX idx_vt_categories_clinic ON volunteer_tracker_categories(clinic_id, sort_order);
...
-- ============================================================
-- 2. volunteer_tracker_columns — dynamic column definitions
-- ============================================================
CREATE TYPE volunteer_tracker_column_type AS ENUM (
  'number',
  'percentage',
  'rating_1_5',
  'text',
...
CREATE INDEX idx_vt_columns_clinic ON volunteer_tracker_columns(clinic_id, sort_order);
...
-- ============================================================
-- 3. volunteer_tracker_entries — one row per volunteer
-- ============================================================
...
CREATE INDEX idx_vt_entries_clinic ON volunteer_tracker_entries(clinic_id);
CREATE INDEX idx_vt_entries_category ON volunteer_tracker_entries(category_id, sort_order);
...
-- ============================================================
-- 4. volunteer_tracker_values — cell values (entry × column)
-- ============================================================
...
CREATE INDEX idx_vt_values_entry ON volunteer_tracker_values(entry_id);
CREATE INDEX idx_vt_values_column ON volunteer_tracker_values(column_id);
