...
const generateCSPPolicy = (isDev: boolean, supabaseUrl: string): string => {
  ...
  const baseDirectives = [
    ...
    "font-src 'self' data:",
    `img-src 'self' data: blob: ${supabaseWildcard} https://*.tiles.mapbox.com https://api.mapbox.com https://storage.googleapis.com https://clinicalhours.org https://*.r2.dev https://img.logo.dev https://www.google.com https://*.gstatic.com`,
    "media-src 'self' blob:",
